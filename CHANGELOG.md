...
### Fixed
- Exclude posts pagination from grid layout
...
### Changed
- Remove bottom margins from post items

## [0.16.3] - 2023-04-23

### Fixed
- A11y: Set `alt` attribute for author avatars

## [0.16.2] - 2023-04-23

### Fixed
- Fix large gap between grid post items
